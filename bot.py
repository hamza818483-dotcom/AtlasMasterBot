...
from tools_handlers import (
    wm_handler, gemini_handler, addgkey_handler,
    update_handler,
...
def main():
    ...
    # Core
    app.add_handler(CommandHandler("start", start_handler))  # Quiz + Normal start
    ...
    app.add_handler(CommandHandler("wm", wm_handler))
